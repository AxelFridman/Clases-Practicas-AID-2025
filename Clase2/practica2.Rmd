...
-   **Ejercicio 8** Simular 8 extracciones con reemplazo de la
...
- **Validacion**: Donde se evalúa el desempeño del modelo en datos no vistos.
- **Test**: Conjunto de datos sobre el cual NO se toman decisiones y sirve para al finalizar reportar metricas
