...
En este primer bloque se instalan y cargan las librerías necesarias. A continuación se lee el archivo CSV que contiene el dataset.
...
En el siguiente bloque se define la ruta del archivo, se carga el dataset y se visualizan las primeras filas:
