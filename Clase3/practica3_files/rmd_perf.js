...
(function(){
try {
   var timings = [ { marker: 'knitr', elapsed: 7670 }, { marker: 'pandoc', elapsed: 230 }, { marker: 'post-processor', elapsed: 60 }, { marker: 'pre-processor', elapsed: 30 }, { marker: 'render', elapsed: 8670 } ];
