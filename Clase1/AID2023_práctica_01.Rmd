...
```{r media_podada}
# Calcula la media podada excluyendo un 10% de los valores en cada extremo
...
x <- c(12, 15, 14, 10, 18, 22, 20, 25)
sd(x) / mean(x) # Relación entre dispersión y media
```
...
```{r binomial}
# Probabilidad de obtener exactamente 3 éxitos en 10 ensayos con p = 0.5
dbinom(3, size = 10, prob = 0.5)

# Probabilidad acumulada P(X <= 3) en una binomial (10, 0.5)
pbinom(3, size = 10, prob = 0.5)

# Cuantil 80% de una binomial (10, 0.5)
qbinom(0.80, size = 10, prob = 0.5)
```
